...
sns.lineplot(x='EVM', y='BER', hue='NoiseLevel', data=grouped, palette="tab10", linewidth=2.5)

# Add points without legend
sns.scatterplot(x='EVM', y='BER', hue='NoiseLevel', data=grouped, palette="tab10", s=100, legend=False)

plt.xlabel('Antennas EVM', fontsize=13)
